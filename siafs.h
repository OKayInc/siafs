...
#define SIAFS_MAX_FILE_SIZE_GB	2048
#define SIAFS_MAX_FILE_SIZE_KB	(SIAFS_MAX_FILE_SIZE_GB * KB_IN_GB)
#define SIAFS_MAX_MULTIPART_SIZE_GB	(SIAFS_MAX_FILE_SIZE_GB / 10000)
#define SIAFS_MAX_MULTIPART_SIZE_KB	(SIAFS_MAX_FILE_SIZE_KB / 10000)
